...
def sign_generation (message,q,p,g,a):
    h_obj = SHA3_256.new()
...
def sign_verification(s,r,i,q,b,p,g):
    v = modinv(i, q)
    z1 = s * v % q
    z2 = r * v % q
...
b=Key_generation(g,a,p)
message=b'Erkay'
#m = int.from_bytes(message, byteorder='big')

s,r,i=sign_generation (message,q,p,g)
ch=sign_verifocation(s,r,i,q,b,p,g)
