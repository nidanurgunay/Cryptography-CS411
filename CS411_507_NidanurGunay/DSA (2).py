...
public_keyBETA=
...
alpha = (((s1 * h2) - (s2*h1*K)) * modinv((s2 * r1 * K - s1 * r2),q)) % q
print("alpha is " + str(alpha))

if Sig_Ver(m1, r1, s1, public_keyBeta, q, p, g):
    print("signature verifies:) for message1 ")
else:
    print("invalid signature:( ")

if Sig_Ver(m2, r2, s2, public_keyBeta, q, p, g):
